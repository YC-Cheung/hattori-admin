<template>
  <div class="app-container">
    <div class="block">
      <el-row>
        <el-col :span="24">
          <el-button v-perm="'create_perm'" type="success" size="mini" icon="el-icon-plus" @click="handleCreate">创建</el-button>
          <el-button v-perm="'update_perm'" type="primary" size="mini" icon="el-icon-edit" @click="handleUpdate">编辑</el-button>
          <el-button v-perm="'delete_perm'" type="danger" size="mini" icon="el-icon-delete" @click="handleDelete">删除</el-button>
          <el-button v-perm="'update_perm_roles'" type="primary" size="mini" icon="el-icon-s-custom" @click="handleUpdatePermRoles">权限角色分配</el-button>
        </el-col>
      </el-row>
    </div>
    <el-table
